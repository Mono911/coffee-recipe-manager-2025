...
export interface Recipe {
  ...
  bean_name: string
  bean_quantity_g: string | number // Changed to support string from DB
  water_temp_c: number
  ...
  // Espresso specific
  pressure_bar?: string | number // Changed to support string from DB
  ...
  rating?: number | null // Changed to support null from DB
  tags: string[]
  notes?: string // Changed to optional to match DB
  roast_level?: string // Changed to string to match DB
  created_at: string
  updated_at: string
}
